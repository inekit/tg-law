...
export class mg11657530440970 implements MigrationInterface {
    name = 'mg11657530440970'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users" ("id" bigint NOT NULL, "last_use" date, "is_captcha_needed" boolean NOT NULL DEFAULT true, "is_subscribed" boolean NOT NULL DEFAULT false, "is_subscribed_private" boolean NOT NULL DEFAULT false, "is_subscribed_add" boolean NOT NULL DEFAULT false, "referer_id" bigint, CONSTRAINT "REL_225203bc7a9057c18dd484f6d2" UNIQUE ("referer_id"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
