...
module.exports = class mg11657803430427 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "users" ("id" bigint NOT NULL, "last_use" date, "wallet_arrd" character varying(255), "nft_count" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "nfts" ("id" integer NOT NULL, CONSTRAINT "PK_65562dd9630b48c4d4710d66772" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('created', 'payed')`);
        await queryRunner.query(`CREATE TABLE "orders" ("id" integer NOT NULL, "nft_id" integer, "customer_id" bigint NOT NULL, "count" integer NOT NULL DEFAULT '1', "sum" integer NOT NULL, "status" "public"."orders_status_enum" NOT NULL DEFAULT 'created', CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
