...
module.exports = class mg11659431221180 {
  name = "mg11659431221180";
  ...
  async up(queryRunner) {
    ...
    await queryRunner.query(
      `ALTER TABLE "lawyers" ADD "rate" double precision`
    );
    await queryRunner.query(
      `ALTER TABLE "lawyers" ADD "rate_count" integer NOT NULL DEFAULT '0'`
    );
    await queryRunner.query(
  ...
  async down(queryRunner) {
    ...
    await queryRunner.query(`ALTER TABLE "lawyers" DROP COLUMN "rate_count"`);
    await queryRunner.query(`ALTER TABLE "lawyers" DROP COLUMN "rate"`);
    await queryRunner.query(
      `ALTER TABLE "answers" ADD CONSTRAINT "FK_b502d28495a3be597f9fe034b55" FOREIGN KEY ("appointment_id") REFERENCES "appointments"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
